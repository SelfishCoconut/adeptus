...
export type AutonomyGrant = components['schemas']['AutonomyGrantRead']
export type AutonomyGrantCreate = components['schemas']['AutonomyGrantCreate']
export type DelegableReason = components['schemas']['DelegableReason']
